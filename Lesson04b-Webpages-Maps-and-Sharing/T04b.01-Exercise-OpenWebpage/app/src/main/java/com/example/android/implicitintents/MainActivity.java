...
public class MainActivity extends AppCompatActivity {
    ...
    public void openWebPage(String uri) {
        Uri uriToOpen = Uri.parse(uri);
        Intent intentToOpenSite = new Intent(Intent.ACTION_VIEW, uriToOpen);

        if(intentToOpenSite.resolveActivity(getPackageManager()) != null) {
            startActivity(intentToOpenSite);
        }
    }
}